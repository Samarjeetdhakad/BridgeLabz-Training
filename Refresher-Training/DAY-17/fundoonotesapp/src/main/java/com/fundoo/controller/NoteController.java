...
import com.fundoo.service.notes.NoteExportService;
...
public class NoteController {
	...
	public ResponseEntity<CreateResponseDTO> createNote(@Valid @RequestBody CreateRequestDTO request) {
		CreateResponseDTO response = noteService.createNote(currentUserId(), request);
	...
	public ResponseEntity<byte[]> exportNotes() throws Exception {
		...
		List<NoteResponseDTO> notes = noteService.findActiveByOwner(currentUserId());
